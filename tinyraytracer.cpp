...
int main() {
    ...
    Material blue_rubber(Vec3f(0.9,  0.1, 0.0), Vec3f(0.1, 0.1, 0.5),   10.);
    Material     mirror(Vec3f(0.0, 10.0, 0.8), Vec3f(1.0, 1.0, 1.0), 1425.);

    std::vector<Sphere> spheres;

    spheres.push_back(Sphere(Vec3f(-5, -5, -12), 2, ivory));
    spheres.push_back(Sphere(Vec3f(1.0, -3, -12), 2, mirror));
    spheres.push_back(Sphere(Vec3f(5, 3, -16), 3, blue_rubber));
